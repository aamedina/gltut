...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 17\ Double\ Projection
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 17\ Double\ ProjectionD
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 17\ Double\ Projection
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 17\ Double\ Projection
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 17 Double Projection
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 17 Double Projection
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Double\ Projection.o: Double\ Projection.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
