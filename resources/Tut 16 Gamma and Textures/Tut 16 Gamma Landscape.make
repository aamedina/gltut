...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 16\ Gamma\ Landscape
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 16\ Gamma\ LandscapeD
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 16\ Gamma\ Landscape
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 16\ Gamma\ Landscape
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 16 Gamma Landscape
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 16 Gamma Landscape
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Gamma\ Landscape.o: Gamma\ Landscape.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/LightEnv.o: LightEnv.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
