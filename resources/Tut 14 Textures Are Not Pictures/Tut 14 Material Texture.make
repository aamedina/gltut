...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 14\ Material\ Texture
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Material\ TextureD
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 14\ Material\ Texture
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Material\ Texture
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 14 Material Texture
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 14 Material Texture
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Material\ Texture.o: Material\ Texture.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
