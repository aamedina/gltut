...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 14\ Perspective\ Interpolation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Perspective\ InterpolationD
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 14\ Perspective\ Interpolation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Perspective\ Interpolation
...
OBJECTS := \
	$(OBJDIR)/Perspective\ Interpolation.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 14 Perspective Interpolation
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 14 Perspective Interpolation
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Perspective\ Interpolation.o: Perspective\ Interpolation.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
