...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 14\ Basic\ Texture
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Basic\ TextureD
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 14\ Basic\ Texture
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 14\ Basic\ Texture
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 14 Basic Texture
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 14 Basic Texture
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Basic\ Texture.o: Basic\ Texture.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
